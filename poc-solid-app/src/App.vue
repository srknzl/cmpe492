<template>
  <div id="app">
    <div id="nav">
      <b-row>
        <b-col>
          <b-navbar toggleable="lg" type="dark" variant="primary">
            <b-navbar-brand href="#">Purposeful Online Community Application Framework</b-navbar-brand>
      ...
      <p
        v-if="loggedIn"
      >Welcome {{ user.split("https://")[1].substring(0,user.split("https://")[1].indexOf(".")) }}</p>
      <b-row>
        <img id="image" />
      </b-row>
    </div>
